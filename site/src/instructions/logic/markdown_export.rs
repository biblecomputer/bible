...
/// Core Markdown export business logic
pub fn export_bible_to_markdown<F>(
    bible: &Bible,
    ...
    F: Fn(f32, String) + Clone + 'static,
{
    ...
    console::log_1(
        &format!(
            "📖 Processing {} books for Markdown export...",
            bible.books.len()
        )
        .into(),
    );
    ...
    console::log_1(
        &format!(
            "📊 Markdown content complete! Processed {} books, {} chapters, {} verses",
    ...
    console::log_1(
        &format!(
            "✅ Markdown export successful! Generated {} characters",
            markdown.len()
        )
        .into(),
    );
