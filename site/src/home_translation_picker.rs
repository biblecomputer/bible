...
use crate::types::{
    ...
    is_translation_downloaded, download_translation, switch_bible_translation, get_current_bible
};
                                        ...
                                        <div class="ml-6">
                                            {
                                                ...
                                                if is_downloaded {
                                                    view! {
                                                        ...
                                                        >
                                                            {
                                                                if is_switching.get() && selected_translation.get() == translation_short_name {
                                                                    "Laden..."
                                                                } else {
                                                                    "Lezen"
                                                                }
